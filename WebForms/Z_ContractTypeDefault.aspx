...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">
		<div>
			...
			<Columns>
				...
				<asp:TemplateField HeaderText="ContractTypeID">
					<EditItemTemplate>
						<asp:Label ID="lblContractTypeID" runat="server" Text='<%# Eval("ContractTypeID") %>'></asp:Label>
					</EditItemTemplate>
					<ItemTemplate>
		...
		<br />
		<br />
		<asp:Button ID="Button1" runat="server" Text="Add New ContractType" OnClick="Button1_Click" CssClass="MehButton" /><br />
		<br />
