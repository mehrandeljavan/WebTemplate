...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">
		<div>
			...
			<Columns>
				...
				<asp:TemplateField HeaderText="ComputationTypeID">
					<EditItemTemplate>
						<asp:Label ID="lblComputationTypeID" runat="server" CssClass="GridViewEditItemLabel" Text='<%# Eval("ComputationTypeID") %>'></asp:Label>
					</EditItemTemplate>
					<ItemTemplate>
		...
		<br />
		<br />
		<asp:Button ID="Button1" runat="server" Text="Add New ComputationType" OnClick="Button1_Click" CssClass="MyButton" /><br />
		<br />
