...
{
public class MonthTypeDBAccess
{
	...
	public List<BaseMonthlyInformation> GetListBaseMonthlyInformation(int monthTypeID)
	{
		...
		using (DataTable table = SqlDBHelper.ExecuteParamerizedSelectCommand("BaseMonthlyInformation_GetList_UseInMonthType", CommandType.StoredProcedure, parametersMonthType))
		{
	...
	public List<ContractualEmployeeReward> GetListContractualEmployeeReward(int monthTypeID)
	{
		...
		using (DataTable table = SqlDBHelper.ExecuteParamerizedSelectCommand("ContractualEmployeeReward_GetList_UseInMonthType", CommandType.StoredProcedure, parametersMonthType))
		{
			//check if any record exists or not
			if (table.Rows.Count > 0)
			{
	...
	public List<DepartmentMonthlyInformation> GetListDepartmentMonthlyInformation(int monthTypeID)
	{
		...
		using (DataTable table = SqlDBHelper.ExecuteParamerizedSelectCommand("DepartmentMonthlyInformation_GetList_UseInMonthType", CommandType.StoredProcedure, parametersMonthType))
		{
			//check if any record exists or not
			if (table.Rows.Count > 0)
			{
	...
	public List<OfficialEmployeeReward> GetListOfficialEmployeeReward(int monthTypeID)
	{
		...
		using (DataTable table = SqlDBHelper.ExecuteParamerizedSelectCommand("OfficialEmployeeReward_GetList_UseInMonthType", CommandType.StoredProcedure, parametersMonthType))
		{
			//check if any record exists or not
			if (table.Rows.Count > 0)
			{
	...
	public bool Delete(int monthTypeID)
	{
		...
		return SqlDBHelper.ExecuteNonQuery("MonthType_Delete", CommandType.StoredProcedure, parametersMonthType);
	}
