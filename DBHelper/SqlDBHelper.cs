...
class SqlDBHelper
{
    //const string CONNECTION_STRING = "server = 172.16.1.26; integrated security = true; database = Ers_Data_Web; User ID=ErsWeb; Password=666";
    const string CONNECTION_STRING = @"server = MEHRAN-PC\SQLEXPRESS; integrated security = false; database = RewrdsDB; User id = sa; Password = 123";
